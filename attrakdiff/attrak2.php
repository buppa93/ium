    ...
    <body>
         <div class="container">
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b3" value="5"></div>
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b4" value="5"></div>
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b5" value="5"></div>
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b6" value="5"></div>
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b7" value="5"></div>
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b8" value="5"></div>
             ...
             <div class="row">
                ...
                <div class="col-lg-1 col-sm-1 col-xs-1" style="background-color:white;"><input type="radio" name="b9" value="5"></div>
