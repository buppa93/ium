<html>
    ...
    <body>
         <div class="container container_attrak">
             ...
             <div class="row">
                <div class="col-lg-1" style="background-color:white;">1.</div>
             ...
             <div class="row">
                <div class="col-lg-1" style="background-color:white;">2.</div>
             ...
             <div class="row">
                 <div class="bttn-group col-lg-12">
                    ...
                    <a href="attrak4.php" class="btn btn-primary action-button" onClick="storeData()">Next</a>
                </div>
             </div>
        </div>
    </body>
